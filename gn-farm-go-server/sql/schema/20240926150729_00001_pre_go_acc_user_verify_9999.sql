...
CREATE INDEX IF NOT EXISTS idx_verify_otp ON pre_go_acc_user_verify_9999 (verify_otp);

-- Add table comment (PostgreSQL: Separate statement)
COMMENT ON TABLE pre_go_acc_user_verify_9999 IS 'account_user_verify';
-- +goose StatementEnd
