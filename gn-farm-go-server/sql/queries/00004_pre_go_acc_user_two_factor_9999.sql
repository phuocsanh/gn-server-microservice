...
INSERT INTO pre_go_acc_user_two_factor_9999 (user_id, two_factor_auth_type, two_factor_phone, two_factor_is_active)
...
-- Assuming a UNIQUE constraint exists on (user_id, two_factor_auth_type) for ON CONFLICT
INSERT INTO pre_go_acc_user_two_factor_9999 (user_id, two_factor_auth_type, two_factor_email, two_factor_is_active)
