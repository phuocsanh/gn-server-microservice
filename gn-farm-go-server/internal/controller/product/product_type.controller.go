...
// ProductTypeRequest represents a request to create a product type
// @Description Product type creation request
...
// ProductSubtypeRequest represents a request to create a product subtype
// @Description Product subtype creation request
...
// ProductSubtypeMappingRequest represents a request to map a product subtype to a product type
// @Description Product subtype mapping request
...
// @Accept       json
// @Produce      json
// @Param        payload body ProductTypeRequest true "Product type details"
...
// @Accept       json
// @Produce      json
// @Param        payload body ProductSubtypeRequest true "Product subtype details"
// @Success      200  {object}  response.ResponseData
// @Failure      400  {object}  response.ErrorResponseData
// @Failure      500  {object}  response.ErrorResponseData
